...
print('\t(monthly) MVP monthly proportion {}: {:.3f}%').format(stock_code_1, proportion_1 * 100.00)
...
print ('')
print ('\t(monthly) Maximum Sharpe ratio: {:.3f}').format(max_r)
...
print ('')
print ('\t(annual) Maximum Sharpe ratio: {:.3f}').format(max_annual_r)
...
print ('')
print ('\t(monthly) Portfolio monthly expected return: {:.3f}%').format((0.5 * max_return + 0.5 * risk_free_rate_monthly) * 100.00)
print ('\tPortfolio monthly standard deviation: {:.3f}%').format((0.5 * max_risk) * 100.00)
print ('')
print ('\t(annual) Portfolio annual expected return: {:.3f}%').format((0.5 * max_return_annual + 0.5 * risk_free_rate) * 100.00)
...
print ('')
print ('\t(monthly) Portfolio monthly expected return: {:.3f}%').format((-0.5 * risk_free_rate_monthly + 1.5 * max_return) * 100.00)
